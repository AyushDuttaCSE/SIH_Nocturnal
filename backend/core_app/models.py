...
class BankBranch(models.Model):
    """Institutional banking directory populated from RBI branch records with geocoded coordinates."""
    rbi_serial_number = models.FloatField(unique=True, null=True, blank=True)
    ...
    def __str__(self):
        return f"{self.bank_name} ({self.branch_name}) - {self.pincode}"